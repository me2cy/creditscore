    ...
    <div class="w-full flex justify-between flex-col md:flex-row space-y-4 md:space-y-0">
        ...
        <div class="w-full md:w-1/2 p-4 h-full">
            <div class="bg-gray-50 shadow-lg p-5 rounded-2xl w-full h-full">
                ...
                <div class="w-full p-4 shadow rounded-xl overflow-x-auto ">
                    <form class="table table-auto text-sm w-full text-left">
                        <div class="w-full py-1 flex justify-between flex-wrap">
                            <div class="w-full py-2 md:w-1/2 px-2">
                                ...
                                <select type="number" class="w-full px-3 py-2 text-sm border-0 shadow-sm rounded-lg">
                            ...
                            <div class="w-full py-2 md:w-1/2 px-2">
                                ...
                                <input type="number" class="w-full px-3 py-2 text-sm border-0 shadow-sm rounded-lg" placeholder="Enter the loan amount here" />
                            </div>
                        </div>
                        ...
                        <div class="w-full">
                            <button class="bg-slate-800 px-5 py-3 rounded-md text-slate-100 hover:text-slate-50 hover:bg-slate-700">
                                Apply
                            </button>
                        </div>
                    </form>
